  ...
  const serverConfigContent = (
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-3">
            ...
            <div className="flex items-center space-x-4">
              <div className="w-20 h-20 bg-muted rounded-card flex items-center justify-center overflow-hidden">
                {homepageIconUrl ? (
      ...
      <div className="space-y-4">
        ...
        {apiKey ? (
          <div className="space-y-4">
            <div className="flex items-center gap-3 p-4 bg-muted/50 rounded-card">
      ...
      <div className="space-y-6">
        ...
        {hasPermission('admin.settings.modify') && (
          <Collapsible open={isBillingExpanded} onOpenChange={setIsBillingExpanded}>
            <CollapsibleTrigger className="flex items-center justify-between w-full p-5 bg-muted/50 rounded-card shadow-card hover:bg-muted/70 transition-colors">
